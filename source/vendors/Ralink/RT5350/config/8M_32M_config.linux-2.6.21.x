...
# CONFIG_DEFAULTS_RALINK_RT3352 is not set
# CONFIG_DEFAULTS_RALINK_RT3883 is not set
CONFIG_DEFAULTS_RALINK_RT5350=y
# CONFIG_DEFSETTING_2M16M is not set
# CONFIG_DEFSETTING_4M16M is not set
# CONFIG_DEFSETTING_4M32M is not set
CONFIG_DEFSETTING_8M32M=y
...
CONFIG_DEFAULTS_BUSYBOX=y
CONFIG_DEFAULTS_UCLIBC=y
CONFIG_DEFAULTS_UCLIBC_PLUS_PLUS=y
