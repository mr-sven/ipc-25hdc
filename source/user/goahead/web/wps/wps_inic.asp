...
function updateWPS(){
	clear_progress_bar();
	makeRequest("/goform/updateWPS", "rai0");
...
<form method="post" name ="WPSConfig" action="/goform/RaixWPSSetup">
<tbody>
<!-- ==================  WPS Config  ================== -->
<tr>
...
<tr>
  <td colspan="2">
	<form method="post" name ="SubmitOOB" action="/goform/RaixOOB">
...
<br />
<!-- ============================    WPS    ============================ -->
<form method="post" name ="WPS" action="/goform/RaixWPS">
...
<tr>
  ...
  <form method="post" name="wps_cancel" action="/goform/WPSRaixCancel">
